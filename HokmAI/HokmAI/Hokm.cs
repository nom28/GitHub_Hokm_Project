...
namespace HokmAI
{
    public partial class Hokm : Form
    {
        ...
        private void Hokm_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 13; i < 0; i++)
            {
                backCards_imageList.Images.Add(Image.FromFile(@"D:\HokmAI\HokmAI\image\cards_back\card" + i + "_1.png"));
            }
        ...
        {
            sign_picture.Image = Image.FromFile(@"D:\HokmAI\HokmAI\image\" + data + ".png");
        }
        ...
        public void SetMyCard(string card, int index)
        {
            ...
            pb[index].Image = Image.FromFile(@"D:\HokmAI\HokmAI\image\cards\" + pic_file_name + ".png");
        }
        
        public void MakeTurn(int playerNumber, string cardPlayed)
        {
            string card_file_name = GetCardFileName(cardPlayed);
            string path = @"D:\HokmAI\HokmAI\image\cards\" + card_file_name + ".png";
            if (playerNumber == 2)
            {
